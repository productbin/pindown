...
export default function Upload() {
  ...
  function Mint() {
    async function doit() {
      ...
      const { write } = useContractWrite(config); // Initialize the useContractWrite hook
    }
    return (
      <div className="flex justify-center">
        <button onClick={doit} className="relative inline-block text-lg group">
  ...
  async function Everything() {
    try {
      imageStorage(); // Assuming imageStorage is an asynchronous function
